...
..  |create_organization_btn| image:: ../_static/regional/organizations/create_organization_submit.png
    :align: middle
    :height: 32px

..  |update_organization_btn| image:: ../_static/regional/organizations/update_organization_btn.png
    :align: middle
    :height: 32px

..  |delete_organization_btn| image:: ../_static/regional/organizations/delete_organization_btn.png
    :align: middle
    :height: 32px
...
.. image:: ../_static/regional/organizations/click_admin.png

2. Click ``New Organization`` to open the organization creation form.

.. image:: ../_static/regional/organizations/click_new_organization.png
...
.. image:: ../_static/regional/organizations/organizations_table.png

3. Click ``Edit Organization`` to open the organization edit form.

.. image:: ../_static/regional/organizations/click_edit_organization.png
